...
var DecisionTree = function(data) {
  ...
  var data = {
    ...
    choices: {
      ...
      'oily skin': {
        name: 'Жирна шкіра',
        children: ['acne', 'large pores', 'oilyness']
      },
      
      'dry skin': {
        name: 'Суха шкіра',
        children: ['acne-dry', 'spots', 'dryness']
      },
      ...
      'oilyness': {
        name: 'Надмірна жирність',
        children: ['salicilic acid', 'centella']
      },
      ...
      'acne-dry': {
        name: 'Акне',
        children: ['lactic acid', 'zink']
      },
      'spots': {
        name: 'Чорні цятки',
        children: ['AHA', 'niaciamide-dry']
      },
      'dryness': {
        name: 'Сухість',
        children: ['hylauronic acid']
      },
  ...
  $(function() {
    ...
    var renderList = function(items) {
      ...
      if(title) {
        ...
        $title.text('Пройди тест та дізнайся компоненти для свого типу шкіри!');
      }
